...
pub fn process_payee_accept_proposal_token_order(
    ...
    ensure_payee_can_respond(order, &id)?;
    require!(
    ...
    let counter_amount = order.payer_made_proposal_amount;
    ...
    ctx.accounts.buyer_order_account.order.closed_reason = OrderClosedReason::PayeeAcceptProposal;
    sync_order_pair(
