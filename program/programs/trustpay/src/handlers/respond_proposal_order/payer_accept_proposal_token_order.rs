...
pub fn process_payer_accept_proposal_token_order(
    ...
    ensure_payer_can_respond(&ctx.accounts.order_account, &id)?;
    require!(
    ...
    let counter_amount = ctx.accounts.order_account.payee_made_proposal_amount;
    ...
    ctx.accounts.order_account.closed_reason = OrderClosedReason::PayerAcceptProposal;
    Ok(())
}
