...
pub fn process_update_enable_adjustable_payment(
    ...
    let previous_enabled = ctx.accounts.config_account.enable_adjustable_payment;
    ctx.accounts.config_account.enable_adjustable_payment = enabled;

    emit!(ConfigUpdated {
        field: "enable_adjustable_payment".to_string(),
