...
use crate::PayeeOrderMessageSet;
...
pub fn process_set_payee_order_message(
    ...
    emit!(PayeeOrderMessageSet {
        ...
        message: ctx.accounts.buyer_order_account.payee_message.clone(),
        is_encrypted,
        payee_ephemeral_pubkey: ctx.accounts.buyer_order_account.payee_ephemeral_pubkey,
        message_nonce: ctx.accounts.buyer_order_account.payee_message_nonce,
    });
    Ok(())
}
